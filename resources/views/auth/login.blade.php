...
<div class="m-login-bg">
    <div class="m-login">
        ...
        <div class="m-login-warp">
            <form class="layui-form" method="post" action="{{url('/business/login')}}">
                {{ csrf_field() }}
                <div class="layui-form-item">
                    <input type="text" value="{{ old('account') }}" name="account" required lay-verify="account" placeholder="用户名" autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <img class="verifyImg" onclick="this.src=this.src+'?c='+Math.random();" src="{{url('/business/verify')}}" />
                    </div>
                    @if (count($errors) > 0)
